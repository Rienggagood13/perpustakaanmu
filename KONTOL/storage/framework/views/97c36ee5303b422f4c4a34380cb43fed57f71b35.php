...
<form action="<?php echo e(url('/produk')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="row mb-5">
        <div class="col-lg-8">
            <div class="card">
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            value="<?php echo e(old('nama_produk')); ?>" autofocus>
...
unset($__errorArgs, $__bag); ?>
                        <input id="desc_produk" type="hidden" name="desc_produk" value="<?php echo e(old('desc_produk')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="harga_produk" name="harga_produk" autocomplete="off" >
                        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klontong_kasep\resources\views/produk/tambah_produk.blade.php ENDPATH**/ ?>