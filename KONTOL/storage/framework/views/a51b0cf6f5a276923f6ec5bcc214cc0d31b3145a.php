...
<head>
    ...
    <title><?php echo e($title); ?> | MAI SAYUR</title>
...
<body>
    ...
    <footer class="footer spad" style="background-color: #0b3005 !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="text-center text-light">Copyright &copy;<?php echo e(date('Y')); ?> All rights reserved</p> </div>
                </div>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\xampp\htdocs\veget-shop\resources\views/layouts/shop.blade.php ENDPATH**/ ?>