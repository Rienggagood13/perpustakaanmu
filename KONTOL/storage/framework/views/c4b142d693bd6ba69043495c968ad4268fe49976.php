                ...
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <div class="breadcrumb__text">
                            <h2 class="text-capitalize">Seller <?php echo e($store->nama_toko); ?></h2>
                      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 mt-1">
                        <a href="<?php echo e(route('shop')); ?>" class="site-btn btn-block text-center"><i class="fas fa-fw fa-store"></i> &nbsp;&nbsp;&nbsp;Kembali</a>
                    </div>
                    <div class="col-lg-7">
                        <div class="hero__search float-right">
                            <div class="hero__search__form">
                                <form  action="<?php echo e(route('detail_shop', $store->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <div class="hero__search__categories">
                                        Pencarian
                                    </div>
                                    <input type="text" placeholder="Cari Sayuran..." autocomplete="off" name="keyword" class="text-dark" value="<?php echo e(($keyword != null) ? $keyword : ''); ?>">
                    ...
                    <div class="col-lg-3 mt-2">
                        <div class="filter__sort float-right">
                            ...
                            <form action="<?php echo e(route('detail_shop', $store->id)); ?>" method="POST" class="d-inline">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="featured__item">
                                        ...
                                        <div class="featured__item__text">
                                            ...
                                            <h5>Rp.<?php echo e(number_format($item->harga_produk, 0, ',', '.')); ?></h5>
                                                ...
                                                <?php else: ?>
                                                    <?php if($item->total > 10): ?>
                                                        <small class="badge st-color"> <?php echo e($item->total); ?> Pcs Terjual</small>
                                                    <?php elseif($item->total > 0 && $item->total < 10): ?>
                                                        <small class="badge st-color"> 0<?php echo e($item->total); ?> Pcs Terjual</small>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-lg-12">
                                ...
                                <div class="pull-right">
                                    <small>
                                        Showing
                                        <?php echo e($produk->firstItem()); ?>

                                        To
                                        <?php echo e($produk->lastItem()); ?>

                                        Of
                                        <?php echo e($produk->total()); ?>
...
<?php echo $__env->make('layouts.shop', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klontong_kasep\resources\views/main/shop.blade.php ENDPATH**/ ?>