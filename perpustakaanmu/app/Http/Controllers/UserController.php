...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('User.tampil',['User'=>$user,'profile'=>$profile]);
    }
    ...
    public function create()
    {
        ...
        $user = User::all()->where('isAdmin','0');
        $profile = Profile::where('users_id',$iduser)->first();
        return view('user.tambah',['user'=>$user,'profile'=>$profile]);
    }
    ...
    public function show($id)
    {
        ...
        return view('User.detail',['user'=>$user,'profile'=>$profile,'pinjamanUser'=>$pinjamanUser]);
    }
    ...
    public function edit($id)
    {
        $user = User::find($id);
        $profile = Profile::where('users_id',$id)->first();
        return view('User.edit',['user'=>$user,'profile'=>$profile]);
    }
    ...
    public function destroy($id)
    {
        ...
        Alert::success('Berhasil', 'Berhasil Mengapus User');
        return redirect('User');
    }
}
