...
@section('content')
    <a href="/User/create" class="btn btn-info mb-3">Tambah User</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (Auth::user()->isAdmin == 1)
                                        <button class="btn btn-info"><a href="/User/{{ $item->id }}"
                                                style="text-decoration: none; color:white;"><i class="fa-solid fa-circle-info"></i></a></button>
                                        <button class="btn btn-warning"><a href="/User/{{ $item->id }}/edit"
